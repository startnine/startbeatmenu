...
namespace StartbeatMenu.Adapters
{
    ...
    public class IMessageEventHandlerViewToContractAddInAdapter : System.AddIn.Pipeline.ContractBase, Start9.Api.Contracts.IMessageEventHandlerContract
    {
        ...
        {
            StartbeatMenu.Views.MessageReceivedEventArgs adaptedArgs;
            adaptedArgs = StartbeatMenu.Adapters.MessageReceivedEventArgsAddInAdapter.ContractToViewAdapter(args);
