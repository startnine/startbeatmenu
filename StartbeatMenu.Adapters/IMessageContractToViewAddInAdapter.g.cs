...
namespace StartbeatMenu.Adapters
{
    ...
    public class IMessageContractToViewAddInAdapter : StartbeatMenu.Views.IMessage
    {
        ...
        public StartbeatMenu.Views.IMessageEntry MessageEntry
        {
            get
            {
                return StartbeatMenu.Adapters.IMessageEntryAddInAdapter.ContractToViewAdapter(_contract.MessageEntry);
            }
        }
