...
namespace StartbeatMenu.Adapters
{
    ...
    {
        internal static StartbeatMenu.Views.IReceiverEntry ContractToViewAdapter(Start9.Api.Contracts.IReceiverEntryContract contract)
        {
            if ((contract == null))
            {
                return null;
        ...
        internal static Start9.Api.Contracts.IReceiverEntryContract ViewToContractAdapter(StartbeatMenu.Views.IReceiverEntry view)
        {
            if ((view == null))
            {
                return null;
