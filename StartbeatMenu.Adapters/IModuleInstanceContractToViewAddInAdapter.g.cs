...
namespace StartbeatMenu.Adapters
{
    ...
    public class IModuleInstanceContractToViewAddInAdapter : StartbeatMenu.Views.IModuleInstance
    {
        ...
        public StartbeatMenu.Views.IModule Instance
        {
            get
            {
                return StartbeatMenu.Adapters.IModuleAddInAdapter.ContractToViewAdapter(_contract.Instance);
            }
        }
