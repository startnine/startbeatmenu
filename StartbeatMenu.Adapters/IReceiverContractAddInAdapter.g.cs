...
namespace StartbeatMenu.Adapters
{
    ...
    {
        internal static StartbeatMenu.Views.IReceiverContract ContractToViewAdapter(Start9.Api.Contracts.IReceiverContractContract contract)
        {
            if ((contract == null))
            {
                return null;
        ...
        internal static Start9.Api.Contracts.IReceiverContractContract ViewToContractAdapter(StartbeatMenu.Views.IReceiverContract view)
        {
            if ((view == null))
            {
                return null;
