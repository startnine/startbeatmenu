...
namespace StartbeatMenu.Adapters
{
    ...
    {
        internal static StartbeatMenu.Views.IModuleInstance ContractToViewAdapter(Start9.Api.Contracts.IModuleInstanceContract contract)
        {
            if ((contract == null))
            {
                return null;
        ...
        internal static Start9.Api.Contracts.IModuleInstanceContract ViewToContractAdapter(StartbeatMenu.Views.IModuleInstance view)
        {
            if ((view == null))
            {
                return null;
