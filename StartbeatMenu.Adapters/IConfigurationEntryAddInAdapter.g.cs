...
namespace StartbeatMenu.Adapters
{
    ...
    {
        internal static StartbeatMenu.Views.IConfigurationEntry ContractToViewAdapter(Start9.Api.Contracts.IConfigurationEntryContract contract)
        {
            if ((contract == null))
            {
                return null;
        ...
        internal static Start9.Api.Contracts.IConfigurationEntryContract ViewToContractAdapter(StartbeatMenu.Views.IConfigurationEntry view)
        {
            if ((view == null))
            {
                return null;
