...
namespace StartbeatMenu.Adapters
{
    ...
    {
        internal static StartbeatMenu.Views.IModuleAssembly ContractToViewAdapter(Start9.Api.Contracts.IModuleAssemblyContract contract)
        {
            if ((contract == null))
            {
                return null;
        ...
        internal static Start9.Api.Contracts.IModuleAssemblyContract ViewToContractAdapter(StartbeatMenu.Views.IModuleAssembly view)
        {
            if ((view == null))
            {
                return null;
