...
namespace StartbeatMenu.Adapters
{
    ...
    {
        internal static StartbeatMenu.Views.MessageReceivedEventArgs ContractToViewAdapter(Start9.Api.Contracts.IMessageReceivedEventArgsContract contract)
        {
            if ((contract == null))
            {
                return null;
        ...
        internal static Start9.Api.Contracts.IMessageReceivedEventArgsContract ViewToContractAdapter(StartbeatMenu.Views.MessageReceivedEventArgs view)
        {
            if ((view == null))
            {
                return null;
